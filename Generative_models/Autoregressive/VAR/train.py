...
def build_everything(args: arg_util.Args):
    ...
    if not args.local_debug:
        ...
        num_classes, dataset_train, dataset_val = build_dataset(
            args.data_path, final_reso=args.data_load_reso, hflip=args.hflip, mid_reso=1.0,
        )
    ...
    #vae_ckpt = '/home/zhouzx/CAR/pre_ckpt/vae_ckpt/vae_ch160v4096z32.pth'
...
def main_training():
    ...
    for ep in range(start_ep, args.ep):
        ...
        path_2="./epoch_time/"+args.dataset_name+".txt"
        ...
        if is_val_and_also_saving:
            ...
            if dist.is_local_master():
                ...
                if (ep + 1) % args.save_iter == 0 or (ep + 1) == args.ep:
                    shutil.copy(local_out_ckpt, local_save_ckpt)
        ...
        if args.dataset_name=="FeTS":
            if (ep+1)%5==0:
                ga(ep,args.ge_vae_ckpt,args.ge_var_ckpt,args.ge_save_path)
        else:
