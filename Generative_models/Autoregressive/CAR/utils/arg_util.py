...
class Args(Tap):
    ...
    tblr: float = 0.0001  # base lr
    local_out_dir_path: str=None
    ...
    ge_var_ckpt:str=''
    ge_car_ckpt:str=''
    #ge_mask_dir:str='/home/zhouzx/CAR/condition_path/Origa/train/class1'
    #ge_imgs_dir:str='/home/zhouzx/CAR/data_path/Origa/train/class1'
    ge_save_dir:str=''
    save_iter:int=1000
    ########################################
    # VAE
