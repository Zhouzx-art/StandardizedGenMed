...
def build_dataset(
    ...
    # build augmentations
    print("----------------------------final_reso:",final_reso)
    print("----------------------------mid_reso:",mid_reso)
    ...
    # build dataset
    train_set = ConditionDatasetFolder(root=data_path, loader=pil_loader, extensions=IMG_EXTENSIONS,
                                       transform=train_aug, train=True, condition_path=condition_path, pn=pn)
    val_set = ConditionDatasetFolder(root=data_path, loader=pil_loader, extensions=IMG_EXTENSIONS,
