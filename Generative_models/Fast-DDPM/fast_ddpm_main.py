    ...
    if not args.test and not args.sample:
        ...
        if args.sample:
            ...
            if args.fid:
                ...
                args.exp, "image_samples", args.doc, args.gen)
    ...
    try:
        ...
        if args.sample:
            if args.dataset=='PMUB':
                runner.sr_sample()
            elif args.dataset=='LDFDCT' or args.dataset=='BRATS' or args.dataset=='ISIC' or args.dataset=='Fundus' or args.dataset=='Polyp' or args.dataset=='Prostate' or args.dataset=='Nuclei' or args.dataset=='FeTS' or args.dataset=='Chaos':
                runner.sg_sample()
            else:
